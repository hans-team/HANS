...
from plauncher import (libplauncher, FilechooserDialog)
...
class EditlauncherDialog(gtk.Dialog):
    __gtype_name__ = "EditlauncherDialog"
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('EditlauncherDialog')
        new_object = builder.get_object('editlauncher_dialog')
